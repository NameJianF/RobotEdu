    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="ibox-content table-responsive">
                <table class="table table-hover table-bordered dataTables-example table-responsive" id="tableSwipeCards"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="formEditTitle">会员卡信息</h4>
            </div>
...
<script src="/javascript/edu/swipecard.js"></script>
